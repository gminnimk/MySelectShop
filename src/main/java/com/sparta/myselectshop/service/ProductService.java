...
public class ProductService {
    ...
    /**
     * ✅ 데이터베이스에서 현재 사용자가 등록한 모든 상품 정보를 조회하여 DTO 리스트로 변환합니다.
     *
     *      ➡️ 데이터베이스에서 사용자가 등록한 상품을 조회하고, 각 상품을 `ProductResponseDto`로 변환하여 반환합니다.
     *
     * @param user 상품을 조회할 사용자 객체입니다.
     * @return List<ProductResponseDto> 사용자가 등록한 모든 상품 정보를 담고 있는 DTO 객체 리스트입니다.
     */
    public List<ProductResponseDto> getProducts(User user) {
        // 데이터베이스에서 현재 사용자가 등록한 모든 상품을 조회합니다.
